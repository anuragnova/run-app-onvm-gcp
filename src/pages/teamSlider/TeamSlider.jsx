...
const teamMembers = [
  ...
  {name: 'Lavanya Lanka', role: 'Cloud DevOps Engineer', image: 'https://storage.googleapis.com/sample-bucket-for-nova/profile-picture/lavanya.jpg',
    description : `Lavanya automates and streamlines the software delivery process in the cloud, from development to deployment. 
    She builds and maintains CI/CD pipelines for rapid and reliable application releases. By implementing Infrastructure-as-Code,
     she ensures consistent and scalable cloud environments. Her work in monitoring and automation enhances system stability and operational efficiency. 
     Lavanya contributes to faster delivery cycles, improved reliability, and efficient cloud operations.`
   },
  { name: 'Anurag Kumar', role: 'Cloud Database Engineer', image: 'https://storage.googleapis.com/sample-bucket-for-nova/profile-picture/anurag.jpg',
    description : `Anurag designs and manages the critical data storage and retrieval systems in the cloud, ensuring data integrity and accessibility. 
    He selects and optimizes database technologies to meet application needs and performance goals. His focus on security and high availability safeguards 
    valuable data assets. Through performance tuning and efficient database management, he enables applications to operate smoothly and reliably. 
    Anurag contributes a robust and performant data layer that powers cloud applications.`
   },
  { name: 'Dhiraj Kumar Prince', role: 'Cloud Storage Engineer', image: 'https://storage.googleapis.com/sample-bucket-for-nova/profile-picture/dhiraj.jpg',
